...
# via https://askubuntu.com/questions/1020692/terminal-splash-screen-with-weather-calendar-time-sysinfo "command line - Terminal splash screen with Weather, Calendar, Time & Sysinfo? - Ask Ubuntu"